...
@:access(undertale.backend.Preferences)
class Controls
{
	...
	function get_GAME_LEFT()
		return FlxG.keys.anyPressed(Preferences.__fields.GAME_LEFT);

	function get_GAME_DOWN()
		return FlxG.keys.anyPressed(Preferences.__fields.GAME_DOWN);

	function get_GAME_UP()
		return FlxG.keys.anyPressed(Preferences.__fields.GAME_UP);

	function get_GAME_RIGHT()
		return FlxG.keys.anyPressed(Preferences.__fields.GAME_RIGHT);
	...
	function get_GAME_DOWN_P()
		return FlxG.keys.anyJustPressed(Preferences.__fields.GAME_DOWN);

	function get_GAME_UP_P()
		return FlxG.keys.anyJustPressed(Preferences.__fields.GAME_UP);

	function get_GAME_RIGHT_P()
		return FlxG.keys.anyJustPressed(Preferences.__fields.GAME_RIGHT);
	...
	function get_GAME_DOWN_R()
		return FlxG.keys.anyJustReleased(Preferences.__fields.GAME_DOWN);

	function get_GAME_UP_R()
		return FlxG.keys.anyJustReleased(Preferences.__fields.GAME_UP);

	function get_GAME_RIGHT_R()
		return FlxG.keys.anyJustReleased(Preferences.__fields.GAME_RIGHT);
	...
	function get_UI_DOWN()
		return FlxG.keys.anyPressed(Preferences.__fields.UI_DOWN);

	function get_UI_UP()
		return FlxG.keys.anyPressed(Preferences.__fields.UI_UP);

	function get_UI_RIGHT()
		return FlxG.keys.anyPressed(Preferences.__fields.UI_RIGHT);

	function get_UI_LEFT_P()
		return FlxG.keys.anyJustPressed(Preferences.__fields.UI_LEFT);

	function get_UI_DOWN_P()
		return FlxG.keys.anyJustPressed(Preferences.__fields.UI_DOWN);

	function get_UI_UP_P()
		return FlxG.keys.anyJustPressed(Preferences.__fields.UI_UP);

	function get_UI_RIGHT_P()
		return FlxG.keys.anyJustPressed(Preferences.__fields.UI_RIGHT);

	function get_UI_LEFT_R()
		return FlxG.keys.anyJustReleased(Preferences.__fields.UI_LEFT);

	function get_UI_DOWN_R()
		return FlxG.keys.anyJustReleased(Preferences.__fields.UI_DOWN);

	function get_UI_UP_R()
		return FlxG.keys.anyJustReleased(Preferences.__fields.UI_UP);

	function get_UI_RIGHT_R()
		return FlxG.keys.anyJustReleased(Preferences.__fields.UI_RIGHT);
