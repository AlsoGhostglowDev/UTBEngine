...
class ScriptUtil {
	/**
	 * All compile defines generated by the compiler.
	 */
	...
	/**
	 * Resolves an hscript-improved generated Abstract class.
	 */
    public static inline function resolveAbstract(name:String):Class<Dynamic> {
        return Type.resolveClass(name + "_HSC");
    }

	/**
	 * Used by hscript to return the runtime type of `obj`.
	 * 
	 * If the type is `hscript.CustomClassHandler` or `hscript.CustomClass`,
	 * then it will be parsed as `hscript.CustomClassHandler<ScriptedClassName>`
	 *
	 * If the type is `hscript.HEnum` or `hscript.HEnumValue`, then it will
	 * be parsed as `hscript.HEnum<ScriptedEnumName>`.
	 */
	...
	/**
	 * Gets all of the import modules from an hscript. Useful for custom `import.hx` module reading.
	 */
	...
	/**
	 * Acts like an `import` from an hscript and returns the
	 * alias name of the package and the module itself
	 */
